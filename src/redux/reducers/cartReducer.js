...
const cartReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case Actions.ADD_ITEM:
      // mevcut ürünün üzerine yeni ürün ekleme
      const updatedCart = state.cart.concat(action.payload);

      return { ...state, cart: updatedCart };

    case Actions.UPDATE_ITEM:
      //actionun payloadı izle, gelen elemanın idsinden yola çıkarak dizideki halini bul ve güncelle
    ...
    case Actions.DELETE_ITEM:
      // idsi bilinen elemanı diziden kaldırma
